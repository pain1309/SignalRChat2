...
export class NewsEffects {
    ...
    @Effect() sendNewItem$ = this.actions$.pipe(ofType<newsAction.SendNewsItemAction>(newsAction.SEND_NEWS_ITEM),
    ...
    @Effect() joinGroup$ = this.actions$.pipe(ofType<newsAction.JoinGroupAction>(newsAction.JOIN_GROUP),
    ...
    @Effect() leaveGroup$ = this.actions$.pipe(ofType<newsAction.LeaveGroupAction>(newsAction.LEAVE_GROUP),
    ...
    @Effect() getAllGroups$ = this.actions$.pipe(ofType(newsAction.SELECTALL_GROUPS),
        switchMap(() => {
